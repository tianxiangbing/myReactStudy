...
/***/ function(module, exports, __webpack_require__) {
	...
	var App = function (_React$Component) {
	    ...
	    function App(props) {
	        ...
	        _this.state = { dialog: null };
	        return _this;
	    }
	
	    _createClass(App, [{
	        key: 'alert',
	        value: function alert(msg, callback) {
	        ...
	        value: function renderDialog() {
	            return _react2.default.createElement(_Dialog2.default, _extends({ App: this }, this.state.dialog));
	        }
	    }, {
	        key: 'open',
	        value: function open() {
...
/***/ function(module, exports, __webpack_require__) {
	...
	console.log(_Header2.default.header);
	...
	var Dialog = function (_Component) {
	    ...
	    _createClass(Dialog, [{
	        ...
	        value: function componentDidMount() {
	            ...
	            setTimeout(function () {
	                if (_this2.state.status !== "closed") {
	                    _this2.setState({ status: "in" });
	                }
	            }, 0);
	        }
	    }, {
	        ...
	        value: function close() {
	            ...
	            setTimeout(function () {
	                _this3.props.App.setState({ dialog: 0 });
	            }, 100);
	            return false;
	        }
	    }, {
	        ...
	        value: function render() {
	            ...
	            var context = this;
	            var d = undefined;
	            var isAlert = !options.buttons || options.buttons.length == 0;
	            console.log(isAlert);
	            if (context.state.show) {
	                d = _react2.default.createElement(
	                    ...
	                    _react2.default.createElement(
	                        'div',
	                        { className: "container " + this.state.status + " " + (isAlert ? "ui-alert" : "") },
	                        _react2.default.createElement(
	                            'div',
	                            { className: 'header' },
	                            options.title
	                        ...
	                        function () {
	                            if (options.buttons && options.buttons.length > 0) {
	                                return _react2.default.createElement(
	                                    'div',
	                                    { 'class': 'footer' },
	                                    (options.buttons || []).map(function (btn, i) {
	                                        return _react2.default.createElement(
	                                            'a',
	                                            { key: i, href: '#',
	                                                onClickCapture: btn.events.click.bind(context, context) },
	                                            btn.text
	                                        );
	                                    })
	                                );
	                    ...
	                    options.mask === false ? "" : _react2.default.createElement('div', { className: 'mask', onClick: this.close.bind(this) })
	                );
	            }
	            return _react2.default.createElement(
	                'div',
